class VirtualDOM {
  ...
  hasChanged(oldNode, newNode) {
    return typeof oldNode !== typeof newNode || typeof oldNode === 'string' && oldNode !== newNode || oldNode.tag !== newNode.tag || JSON.stringify(oldNode.attrs) !== JSON.stringify(newNode.attrs);
  }
}
